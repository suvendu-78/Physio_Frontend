        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
          <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <button
              ...
              className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-600 transition"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            {/* Content */}
            <div className="px-6 sm:px-10 pt-5 pb-8 text-center">
              <p className="text-xs font-bold uppercase tracking-widest text-emerald-600 mb-2">
                Booking Information
              </p>

              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 leading-tight">
                We Only Take Bookings
                <span className="block text-[#004d40]">
                  on Call or WhatsApp Right Now
                </span>
              </h2>

              <p className="mt-4 text-sm sm:text-base text-slate-500 leading-relaxed">
                Our online booking system is currently unavailable. Please
                contact us directly to book your consultation.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-6">
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-[#004d40] hover:bg-[#00382f] text-white font-bold transition shadow-md"
                >
              ...
              <div className="mt-6 bg-emerald-50 border border-emerald-100 rounded-xl px-4 py-3">
                <p className="text-sm font-semibold text-emerald-800">
                  ❤️ Thank you for your understanding!
                </p>
              </div>
