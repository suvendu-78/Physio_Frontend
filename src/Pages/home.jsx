...
const Homes = () => {
  ...
  const services = [
    { id: 1, title: "Physio", icon: Activity },
    { id: 2, title: "Neuro", icon: Brain },
    { id: 3, title: "Orthophysiotherapist", icon: Stethoscope },
    { id: 4, title: "Eye Therapy", icon: Sparkles },
    { id: 5, title: "Tele Therapy", icon: UserCheck },
  ];
