...
const PatientDashboard = () => {
  ...
  const firstName = getValue(info?.FName);
  const address = getValue(info?.Address);
  const mobile = getValue(info?.Mobile);
  const email = getValue(info?.Email);
  const role = getValue(info?.Role);

  const firstLetter =
    info?.FName && String(info.FName).trim()
      ? String(info.FName).charAt(0).toUpperCase()
      : "?";

  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      <div className="bg-gradient-to-r from-teal-900 to-slate-900 px-4 py-8 text-white sm:px-8">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div className="flex items-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border-2 border-amber-400 bg-teal-600 text-2xl font-bold">
              {firstLetter}
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-teal-200">{address}</p>

              <p className="mt-1 text-xs text-teal-100">Mob: {mobile}</p>

              <p className="text-xs text-teal-100">Email: {email}</p>

              <p className="mt-1 text-xs text-teal-200">Role: {role}</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <NavLink
              to="/services"
              className="flex items-center gap-2 rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-bold text-slate-950 shadow transition hover:bg-amber-600"
            >
            ...
            <button
              onClick={handleLogout}
              className="flex items-center gap-2 rounded-lg bg-red-600 px-5 py-2.5 text-sm font-bold text-white shadow transition hover:bg-red-700"
            >
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-8 sm:px-8 lg:grid-cols-4">
        ...
        <div className="space-y-6 lg:col-span-3">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="rounded-lg bg-teal-100 p-2.5 text-teal-800">
          ...
          {activeTab === "appointments" && (
            <div className="space-y-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
                <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                  <div className="space-y-2">
                    ...
                    <p className="pt-2 text-xs font-medium text-slate-800">
                      Date: Not present
                    </p>
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      type="button"
                      className="rounded-lg bg-slate-300 px-4 py-2 text-xs font-medium text-slate-500"
                      disabled
                    >
                      View Live Status
                    </button>
                    ...
                    <button
                      type="button"
                      className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-xs font-medium text-slate-500"
                      disabled
                    >
                      Reschedule
                    </button>
              ...
              <h3 className="border-t border-slate-100 pt-4 text-md font-bold text-slate-900">
                Past Appointment History
              </h3>
          ...
          {activeTab === "reports" && (
            <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="flex items-center gap-2 rounded-lg bg-teal-700 px-3 py-1.5 text-xs font-medium text-white"
                >
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 p-5 text-center">
                ...
                <p className="mt-1 text-xs text-slate-400">Not present</p>
              </div>
            </div>
          )}
